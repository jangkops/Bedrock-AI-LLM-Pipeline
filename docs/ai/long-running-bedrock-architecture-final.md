...
|-----------|-------------|----------|
| API Gateway type | **REST API (Regional)** | API ID `5l764dh7y9` in all IAM policies, `bedrock_gw.py`, shell hook |
...
1. Destroyed the REST API (`5l764dh7y9`)
...
1. Was never applied (live infra is still REST API `5l764dh7y9`)
